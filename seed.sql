...
-- USUARIOS
-- =========================
INSERT INTO usuarios (nombre, mail, puntos) VALUES
('Facundo', 'facu@gmail.com', 0),
('Juan', 'juan@gmail.com', 0),
('Maria', 'maria@gmail.com', 0);

-- =========================
-- PARTIDOS - FASE DE GRUPOS (MUNDIAL 2026 - MOCK SIN TILDES)
-- =========================
...
('Mexico', 'Sudafrica', 'MetLife Stadium', 'New York', '2026-06-11 16:00:00',
 (SELECT id_fase FROM fases WHERE nombre = 'grupo')),
